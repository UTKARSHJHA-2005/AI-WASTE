...
const Dashboard = () => {
    ...
    return (
        <div className="min-h-screen overflow-x-hidden overflow-y-hidden bg-gradient-to-br from-green-50 to-blue-50">
            {/* Navigation Bar */}
            <motion.nav
                className="flex justify-between items-center py-4 px-8 md:px-16 bg-white/80 backdrop-blur-sm border-b border-green-100 sticky top-0 z-10"
            ...
            >
                <motion.div className="flex items-center" whileHover={{ scale: 1.05 }}>
                    <div onClick={() => navigate("/")} className="flex items-center cursor-pointer">
                        <img src={ecoLogo} alt="EcoGenie Logo" className="h-8 w-8 mr-2" />
