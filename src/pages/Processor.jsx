      ...
      <motion.div
            ...
            <div className="flex items-center w-full md:w-auto mb-4 md:mb-0">
              <div className="relative flex-grow md:w-80">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-3 w-[800px] border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none"
                  value={location}
                  onChange={(e) => setLocation(e.target.value)} />
              </div>
              <motion.button
                className="ml-[500px] bg-green-700 text-white px-4 py-3 rounded-lg"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}>
                Search
              </motion.button>
        ...
        {/* <motion.div className="rounded-xl overflow-hidden shadow-md mb-16 border border-green-100" initial={{ opacity: 0, y: 30 }}
          ...
          <div className="h-[20%] w-full relative">
            <img src={map} alt="Map of waste processors" className="w-full h-[30%] object-cover"/>
          </div>
        </motion.div> */}
