...
import { Sprout, Mail, Lock, ArrowRight, Leaf, Cloud, Wind } from "lucide-react"
...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-green-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <motion.div
        className="absolute top-20 right-20 text-green-200 opacity-50"
      ...
      <motion.div
        className="absolute bottom-20 left-20 text-green-200 opacity-40"
        initial={{ x: 0 }}
        animate={{
          x: [0, 10, 0, -10, 0],
      ...
      <motion.div
        className="absolute top-1/3 left-1/5 text-blue-200 opacity-30"
        initial={{ y: 0 }}
