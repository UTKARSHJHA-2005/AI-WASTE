...
import { Sprout, User, Mail, Lock, ArrowRight, Leaf, Cloud, TreePine } from "lucide-react"
...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-green-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <motion.div
        className="absolute top-10 right-10 text-green-200 opacity-50"
      ...
      <motion.div
        className="absolute bottom-10 left-10 text-green-200 opacity-50"
        variants={leafAnimation}
        initial="initial"
        animate="animate"
      ...
      <motion.div
        className="absolute top-1/4 left-1/4 text-blue-200 opacity-30"
        initial={{ y: 0 }}
      ...
      >
        ...
        <motion.h2
          className="mt-6 text-center text-3xl font-extrabold text-green-900"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.p
          className="mt-2 text-center text-sm text-green-700"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
